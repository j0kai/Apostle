...
#define PROFILE 0
    ...
    #define AP_PROFILE_SCOPE(name) ::Apostle::InstrumentationTimer timer##__LINE__(name)
    #define AP_PROFILE_FUNCTION() AP_PROFILE_SCOPE(__FUNCSIG__)
#else
    #define AP_PROFILE_BEGIN_SESSION(name, filepath)
    #define AP_PROFILE_END_SESSION()
    #define AP_PROFILE_SCOPE(name)
    #define AP_PROFILE_FUNCTION()
#endif